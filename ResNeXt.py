...
def ResNeXt50_32x4d_body_stride16(cfg):
    return ResNeXt_body(cfg,(3, 4, 6, 3), 32, 4, 16)


def ResNeXt101_32x4d_body_stride16(cfg):
    return ResNeXt_body(cfg,(3, 4, 23, 3), 32, 4, 16)


class ResNeXt_body(nn.Module):
    def __init__(self, cfg,block_counts, cardinality, base_width, output_stride):
        super().__init__()
        self.cfg = cfg
    ...
    def _init_modle(self):
        ...
        if self.cfg['FREEZE_BACKBONE_BN']:
